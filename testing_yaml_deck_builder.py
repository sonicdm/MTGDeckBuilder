...
from mtg_deck_builder.yaml_builder.yaml_deckbuilder import build_deck_from_yaml# build_deck_from_yaml now orchestrates helpers
...
def main():
    ...
    yaml_path = r"Z:\Scripts\MTGDecks\tests\sample_data\yaml_test_template.yaml"
    ...
    # setup callbacks
    callbacks = {
        "after_inventory_load": log_inventory_load,
        "after_deck_build": log_summary,
        "after_deck_finalize": log_deck_config_details,
        "after_mana_base": log_repo_filter_state,
        "after_priority_cards": log_repo_filter_state,
        "after_special_lands": log_special_lands,
        "after_fill_categories": log_summary,
        "after_fill_with_any": log_before_fallback_fill,
        "after_deck_config_load": log_after_deck_config_load
    }

    deck = build_deck_from_yaml(yaml_path, card_repo, inventory_repo=inventory_repo, callbacks=callbacks)  # refactored, but call unchanged
    if deck is None:
